...
const PointsPage = () => {
    ...
    return (
        <div style={{ marginBottom: "10vh" }}>
            <p>
                I developed <a href="https://points.practicalmedia.io" style={{ color: "cyan" }}>Practical Analytics</a>, a streamlined platform tailored for PracticalNPC, which serves as an all-in-one solution for tracking Twitch viewer engagement through rewards and redeems. This engaging website showcases a leaderboard featuring all connected streamers and their viewers, encouraging healthy competition for the coveted top spot. Since launching the platform and sharing it with streamers in the game development community, we have observed a remarkable increase in reward engagement across their channels, highlighting the positive impact of our innovative tool.
            </p>
